      ...
      foreach ($categories as $category_id) {
        ...
        if ($category_info) {
          if ($category_info['image']) {
            $image = $this->model_tool_image->resize($category_info['image'], $setting['width'], $setting['height'], $this->config->get('config_category_image_mode'));
          } else {
            $image = $this->model_tool_image->resize('placeholder.png', $setting['width'], $setting['height'], $this->config->get('config_category_image_mode'));
          }
