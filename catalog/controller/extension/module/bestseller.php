  ...
  public function index($setting) {
    ...
    if ($results) {
      foreach ($results as $result) {
        if ($result['image']) {
          $image = $this->model_tool_image->resize($result['image'], $setting['width'], $setting['height'], $this->config->get('config_product_list_image_mode'));
        } else {
          $image = $this->model_tool_image->resize('placeholder.png', $setting['width'], $setting['height'], $this->config->get('config_product_list_image_mode'));
        }
