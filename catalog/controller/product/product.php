...
class ControllerProductProduct extends Controller {
  ...
  public function index() {
    ...
    if ($product_info) {
      ...
      if($this->config->get('config_show_product_siblings')) {
        $data['siblings'] = array();

        $results = $this->model_catalog_product->getProductSiblings($this->request->get['product_id'], 8);
      ...
      $results = $this->model_catalog_product->getArticleRelatedByProduct($this->request->get['product_id']);
