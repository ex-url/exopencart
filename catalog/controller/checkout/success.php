...
class ControllerCheckoutSuccess extends Controller {
	public function index() {
		...
		if (!empty($this->session->data['last_order_id']) ) {
			$this->document->setTitle(sprintf($this->language->get('heading_title'), $this->session->data['last_order_id']));
		...
		if (!empty($this->session->data['last_order_id'])) {
			$data['heading_title'] = sprintf($this->language->get('heading_title'), $this->session->data['last_order_id']);
		} else {
