  ...
  public function index() {
      ...
      foreach ($parts as $path_id) {
        ...
        if ($category_info) {
          ...
          $breadcrumbsItemList[] = [
            ...
            "item" => $this->url->link('blog/category', 'blog_category_id=' . $path)
          ];
    ...
    if ($category_info) {
      ...
      $breadcrumbsItemList[] = [
        ...
        "position" => $schema_position,
        "name" => $category_info['name'],
        "item" => $this->url->link('blog/category', 'blog_category_id=' . $this->request->get['blog_category_id'])
      ];

      $category_url = $this->url->link('blog/category', 'blog_category_id=' . $this->request->get['blog_category_id']);
      ...
      $image_width = $this->config->get('configblog_image_article_width');
      $image_height = $this->config->get('configblog_image_article_height');
      ...
      foreach ($results as $result) {
        ...
        $blogItemList[] = [
          "@type" => "BlogPosting",
          "@id" => $this->url->link('blog/article', 'blog_category_id=' . $this->request->get['blog_category_id'] . '&article_id=' . $result['article_id']) . "#blog-posting",
          "headline" => $result['name'],
          "image" => $image,
          "url" => $this->url->link('blog/article', 'blog_category_id=' . $this->request->get['blog_category_id'] . '&article_id=' . $result['article_id']),
      ...
      $data['sorts'][] = array(
        ...
        'value' => 'p.date_published-ASC',
        'href'  => $this->url->link('blog/category', 'blog_category_id=' . $this->request->get['blog_category_id'] . '&sort=p.date_published&order=ASC' . $url)
      );

      $data['sorts'][] = array(
        'text'  => $this->language->get('text_date_desc'),
        'value' => 'p.date_published-DESC',
        'href'  => $this->url->link('blog/category', 'blog_category_id=' . $this->request->get['blog_category_id'] . '&sort=p.date_published&order=DESC' . $url)
      );
