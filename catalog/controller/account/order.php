    ...
    if ($order_info) {
      ...
      foreach ($products as $product) {
        ...
        $data['products'][] = array(
          ...
          'reorder'  => $reorder,
          'return'   => $this->url->link('account/return/add', 'order_id=' . $order_info['order_id'] . '&id=' . $product['product_id'], true),
      ...
      $data['heading_title'] = sprintf($this->language->get('text_order_title'), $order_id);
