...
$_['text_new_affiliate']            = 'Стать партнером';
$_['text_register_account']         = '<p>Нажмите кнопку ниже, чтобы создать учетную запись партнера. Обратите внимание, что эта учетная запись никак не связана с какой либо учетной записью покупателя!</p>';
