...
$_['text_checkout_payment_address']  = 'Адрес плательщика';
...
$_['text_agree']                     = 'Соглашаюсь на обработку персональных данных на условиях статьи <a href="%s" class="agree">%s</a>';
$_['text_address_new']               = 'Новый адрес';
$_['text_address_existing']          = 'Существующий адрес';
...
$_['entry_address_2']                = 'Дом, квартира, офис';
$_['entry_postcode']                 = 'Почтовый индекс';
$_['entry_city']                     = 'Город';
$_['entry_country']                  = 'Страна';
$_['entry_zone']                     = 'Регион / Область';
$_['entry_newsletter']               = 'Я хочу подписаться на рассылку новостей %s.';
$_['entry_billing_for_shipping']     = 'Использовать как адреса доставки';
$_['entry_create_account']             = 'Зарегистрироваться';
...
$_['error_approved']                 = 'Аккаунт успешно создан! Вы сможете войти после проверки учётной записи администрацией магазина.';
...
$_['error_telephone']                = 'Номер телефона - обязательное поле!';
$_['error_password']                 = 'Пароль должен содержать от 3 до 20 символов!';
$_['error_confirm']                  = 'Пароли не совпадают!';
$_['error_address_1']                = 'Улица - обязательное поле! (3 - 128 символов)';
$_['error_address_2']                = 'Дом, квартира, офис - обязательное поле! (1 - 64 символа)';
$_['error_city']                     = 'Город - обязательное поле! (2 - 128 символов)';
$_['error_postcode']                 = 'Индекс - обязательное поле! (2 - 10 символов)';
$_['error_country']                  = 'Пожалуйста, укажите страну!';
$_['error_zone']                     = 'Пожалуйста, укажите регион / область!';
$_['error_agree']                    = 'Вы должны согласится на обработку персональных данных!';
...
$_['error_pickup_point']             = 'Выберите пункт выдачи заказа!';
