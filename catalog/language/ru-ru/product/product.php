...
$_['text_wholesale']           = 'Оптом дешевле';
$_['text_points']              = 'Цена в бонусах';
...
$_['text_siblings']            = 'Похожие товары';
...
$_['error_review_images_limit'] = 'Максимальное количество изображений для отзыва: %s!';
$_['error_upload']  = 'Ошибка загрузки файла!';
$_['error_file_size']  = 'Превышен максимальный размер файла!';
