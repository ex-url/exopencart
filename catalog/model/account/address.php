...
class ModelAccountAddress extends Model {
  ...
  public function getAddressByData($customer_id, $data) {
    $city = mb_strtolower(trim($data['city']));
    $address_1 = mb_strtolower(trim($data['address_1']));
    $address_2 = isset($data['address_2']) ? mb_strtolower(trim($data['address_2'])) : '';
    ...
    $query = $this->db->query("
        ...
        AND LOWER(TRIM(city)) = '" . $this->db->escape($city) . "' 
        AND LOWER(TRIM(address_1)) = '" . $this->db->escape($address_1) . "' 
        AND LOWER(TRIM(address_2)) = '" . $this->db->escape($address_2) . "'
        LIMIT 1
    ");
