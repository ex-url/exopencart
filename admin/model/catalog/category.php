...
class ModelCatalogCategory extends Model {
  public function addCategory($data) {
    $this->db->query("INSERT INTO " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', sort_param = '" . $this->db->escape($data['sort_param']) . "', sort_direction = '" . $this->db->escape($data['sort_direction']) . "', redirect = '" . $this->db->escape($data['redirect']) . "', status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "', date_modified = NOW(), date_added = NOW()");
  ...
  public function editCategory($category_id, $data) {
    $this->db->query("UPDATE " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', sort_param = '" . $this->db->escape($data['sort_param']) . "', sort_direction = '" . $this->db->escape($data['sort_direction']) . "', redirect = '" . $this->db->escape($data['redirect']) . "', status = '" . (int)$data['status'] . "', noindex = '" . (int)$data['noindex'] . "', date_modified = NOW() WHERE category_id = '" . (int)$category_id . "'");
