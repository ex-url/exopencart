...
$_['help_column']            = 'Количество столбцов в выпадающем меню категории (не используется по-умолчанию, но может использоваться в шаблонах с поддержкой выпадающих меню)';
