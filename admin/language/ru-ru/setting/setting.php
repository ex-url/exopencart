...
$_['entry_default_mode']               = 'Тема по-умолчанию';
$_['entry_toggle_mode']                = 'Показывать переключатель';
...
// Help
$_['help_default_mode']                = 'Выбранная цветовая схема будет отображаться по-умолчанию';
$_['help_toggle_mode']                 = 'Пользователи смогут переключать тему оформления самостоятельно';
