...
$_['help_show_date']        = 'Показывать дату публикации статьи в списке статей и на странице статьи';
$_['help_show_viewed']      = 'Показывать количество просмотров статьи в списке статей и на странице статьи';
$_['help_show_author']      = 'Показывать автора статьи в списке статей и на странице статьи';
$_['help_video']        = 'Видео для встраивания на страницу статьи. Поддерживаются видео с YouTube, Vimeo и других видеохостингов. Для встраивания видео используйте код из поля "Поделиться" на странице видео.';
