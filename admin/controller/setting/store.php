...
class ControllerSettingStore extends Controller {
  ...
  protected function getForm() {
    ...
    if (isset($this->request->post['config_title_seo_phrase'])) {
      $data['config_title_seo_phrase'] = $this->request->post['config_title_seo_phrase'];
    } elseif (isset($store_info['config_title_seo_phrase'])) {
      $data['config_title_seo_phrase'] = $store_info['config_title_seo_phrase'];
    } else {
      $data['config_title_seo_phrase'] = '';
    }

    if (isset($this->request->post['config_heading_seo_phrase'])) {
      $data['config_heading_seo_phrase'] = $this->request->post['config_heading_seo_phrase'];
    } elseif (isset($store_info['config_heading_seo_phrase'])) {
      $data['config_heading_seo_phrase'] = $store_info['config_heading_seo_phrase'];
    } else {
      $data['config_heading_seo_phrase'] = '';
    }
    ...
    if (isset($this->request->post['config_postal'])) {
      $data['config_postal'] = $this->request->post['config_postal'];
    } elseif (isset($store_info['config_postal'])) {
      $data['config_postal'] = $store_info['config_postal'];
    } else {
      $data['config_postal'] = '';
    }
    ...
    } elseif (isset($store_info['config_og_fallback'])) {
      $data['config_og_fallback'] = $store_info['config_og_fallback'];
    } else {
      $data['config_og_fallback'] = '';
    }
    ...
    } elseif (isset($store_info['config_og_fallback_width'])) {
      $data['config_og_fallback_width'] = $store_info['config_og_fallback_width'];
    } else {
    ...
    } elseif (isset($store_info['config_og_fallback_height'])) {
      $data['config_og_fallback_height'] = $store_info['config_og_fallback_height'];
    } else {
    ...
    if (isset($this->request->post['config_og_fallback']) && is_file(DIR_IMAGE . $this->request->post['config_og_fallback'])) {
      $data['og_fallback'] = $this->model_tool_image->resize($this->request->post['config_og_fallback'], 100, 100);
    } elseif (isset($store_info['config_og_fallback']) && is_file(DIR_IMAGE . $store_info['config_og_fallback'])) {
      $data['og_fallback'] = $this->model_tool_image->resize($store_info['config_og_fallback'], 100, 100);
    } else {
