...
class ControllerSettingSetting extends Controller {
  ...
  public function index() {
    ...
    if (isset($this->request->post['config_title_seo_phrase'])) {
      ...
      $data['config_title_seo_phrase'] = $this->config->get('config_title_seo_phrase');
    }
    ...
    if (isset($this->request->post['config_heading_seo_phrase'])) {
      ...
      $data['config_heading_seo_phrase'] = $this->config->get('config_heading_seo_phrase');
    }
    ...
    if (isset($this->request->post['config_postal'])) {
      ...
      $data['config_postal'] = $this->config->get('config_postal');
    }
    ...
    } elseif ($this->config->get('config_logo_width')) {
      $data['config_logo_width'] = $this->config->get('config_logo_width');
    } else {
    ...
    } elseif ($this->config->get('config_logo_height')) {
      $data['config_logo_height'] = $this->config->get('config_logo_height');
    } else {
    ...
    if (isset($this->request->post['config_admin_code'])) {
      $data['config_admin_code'] = $this->request->post['config_admin_code'];
    } else {
      $data['config_admin_code'] = $this->config->get('config_admin_code');
    }
