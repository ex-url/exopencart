...
class ControllerCatalogAttribute extends Controller {
  ...
  public function default() {
    ...
    if (isset($this->request->get['attribute_id']) && isset($this->request->get['language_id'])) {
      $this->load->model('catalog/attribute');

      $attribute_id = (int)$this->request->get['attribute_id'];
      $language_id = (int)$this->request->get['language_id'];

      $json = $this->model_catalog_attribute->getAttributeDefaultValues($attribute_id, $language_id);
    }
