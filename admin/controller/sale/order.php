  ...
  public function addCommission() {
    ...
    if (!$this->user->hasPermission('modify', 'sale/order')) {
      ...
      if ($order_info) {
        ...
        if (!$affiliate_total) {
          $this->model_customer_customer->addTransaction($order_info['affiliate_id'], $this->language->get('text_order_affiliate_commission') . ' #' . $order_id, $order_info['commission'], $order_id);
        }
      }
