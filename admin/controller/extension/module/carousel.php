  ...
  public function index() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
      if (!isset($this->request->get['module_id'])) {
        $module_id = $this->model_setting_module->addModule('carousel', $this->request->post);
      } else {
      ...
      if (isset($this->request->post['apply']) && $this->request->post['apply'] == 1) {
        ...
        $this->response->redirect($this->url->link('extension/module/carousel', 'user_token=' . $this->session->data['user_token'] . $url, true));
      } else {
    ...
    if (isset($this->request->post['desktop_items'])) {
      $data['desktop_items'] = $this->request->post['desktop_items'];
    } elseif (!empty($module_info)) {
      $data['desktop_items'] = $module_info['desktop_items'];
    } else {
      $data['desktop_items'] = '';
    }

    if (isset($this->request->post['tablet_items'])) {
      $data['tablet_items'] = $this->request->post['tablet_items'];
    } elseif (!empty($module_info)) {
    ...
    if (isset($this->request->post['mobile_items'])) {
      $data['mobile_items'] = $this->request->post['mobile_items'];
    } elseif (!empty($module_info)) {
