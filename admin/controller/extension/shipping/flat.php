...
class ControllerExtensionShippingFlat extends Controller {
  ...
  public function index() {
    ...
    if (isset($this->request->post['shipping_flat_free'])) {
      $data['shipping_flat_free'] = $this->request->post['shipping_flat_free'];
    } else {
      $data['shipping_flat_free'] = $this->config->get('shipping_flat_free');
    }
