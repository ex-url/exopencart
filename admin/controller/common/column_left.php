...
class ControllerCommonColumnLeft extends Controller {
  public function index() {
    if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
      ...
      if ($this->user->hasPermission('access', 'localisation/quantity_class')) {
        $localisation[] = array(
          'name'     => $this->language->get('text_quantity_class'),
          'href'     => $this->url->link('localisation/quantity_class', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
      }
